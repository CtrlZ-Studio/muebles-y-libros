...
const AboutSection = ({ aboutData }) => {
  return (
    <article className="relative min-h-screen lg:h-screen tw-py tw-px text-accent-dark scroll-snap-start">
      <SectionHeader bg="bg-accent-dark" text="text-white">
        {WEB_NAME} // {aboutData.heading}
      </SectionHeader>

      <section className="h-full flex flex-col lg:flex-row lg:space-x-24 2xl:space-x-48 space-y-12 md:space-y-16 lg:space-y-0">
        ...
        <div className="relative items-center h-48 md:h-96 lg:h-full w-full lg:w-1/2">
          <Image
